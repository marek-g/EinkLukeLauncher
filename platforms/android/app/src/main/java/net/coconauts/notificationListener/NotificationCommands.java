...
public class NotificationCommands extends CordovaPlugin {
    ...
    public static void notifyListener(StatusBarNotification n,String action){
      if (listener == null) {
      ...
      try  {
        ...
        JSONObject json = parse(n,action);
    ...
    private static JSONObject parse(StatusBarNotification n,String action)  throws JSONException{
        ...
        json.put("clear", n.isClearable() );
        json.put("key",n.getKey());
